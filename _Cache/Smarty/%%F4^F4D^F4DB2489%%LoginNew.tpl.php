...
<?php $this->_cache_serials['Lib/App/../../_Cache/Smarty\%%F4^F4D^F4DB2489%%LoginNew.tpl.inc'] = '0870be1d1c56a72eaa3508046299e62d'; ?><!DOCTYPE html>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><?php if ($this->caching && !$this->_cache_including) { echo '{nocache:0870be1d1c56a72eaa3508046299e62d#0}';}echo $this->_plugins['function']['webcontrol'][0][0]->_pi_func_webcontrol(array('type' => 'GetAppInf','varName' => 'systemV'), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:0870be1d1c56a72eaa3508046299e62d#0}';}?>
</title>
...
<body>
	<div class="container">
		<div class="header">
			...
			<div class="link">
				<span><?php if ($this->caching && !$this->_cache_including) { echo '{nocache:0870be1d1c56a72eaa3508046299e62d#1}';}echo $this->_plugins['function']['webcontrol'][0][0]->_pi_func_webcontrol(array('type' => 'GetAppInf','varName' => 'systemV'), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:0870be1d1c56a72eaa3508046299e62d#1}';}?>
</span>
				&nbsp;|&nbsp;
		...
		<div class="content" id="content">
	        ...
	        <div class="input input_block" id="kuaijie_form">
	        	<form action="<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:0870be1d1c56a72eaa3508046299e62d#2}';}echo $this->_plugins['function']['url'][0][0]->_pi_func_url(array('controller' => $_GET['controller'],'action' => 'login'), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:0870be1d1c56a72eaa3508046299e62d#2}';}?>
" method="post" autocomplete='off' id="form_login">
 ...
 EQINFO Inc. All Rights Reserved.</span>
		...
		<form action="<?php if ($this->caching && !$this->_cache_including) { echo '{nocache:0870be1d1c56a72eaa3508046299e62d#3}';}echo $this->_plugins['function']['url'][0][0]->_pi_func_url(array('controller' => $_GET['controller'],'action' => 'createshortcuts'), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:0870be1d1c56a72eaa3508046299e62d#3}';}?>
