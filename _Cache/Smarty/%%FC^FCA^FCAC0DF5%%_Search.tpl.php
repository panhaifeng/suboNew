...
<?php $this->_cache_serials['Lib/App/../../_Cache/Smarty\%%FC^FCA^FCAC0DF5%%_Search.tpl.inc'] = '39c038d956bbdb659baf62f777dd055b'; ?><div id=searchGuide  class='x-hide-display'>
...
unset($_smarty_tpl_vars);
 ?></tt>
		...
		<td id="edit" align="right" style="padding-right:10px;">
			...
			<a class="button_href" href="<?php if ($this->_tpl_vars['add_url'] == ''):  if ($this->caching && !$this->_cache_including) { echo '{nocache:39c038d956bbdb659baf62f777dd055b#0}';}echo $this->_plugins['function']['url'][0][0]->_pi_func_url(array('controller' => $_GET['controller'],'action' => 'add'), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:39c038d956bbdb659baf62f777dd055b#0}';}?>
			...
			<a class="button_href" href="<?php if ($this->_tpl_vars['list_url'] == ''):  if ($this->caching && !$this->_cache_including) { echo '{nocache:39c038d956bbdb659baf62f777dd055b#1}';}echo $this->_plugins['function']['url'][0][0]->_pi_func_url(array('controller' => $_GET['controller'],'action' => 'list'), $this);if ($this->caching && !$this->_cache_including) { echo '{/nocache:39c038d956bbdb659baf62f777dd055b#1}';}?>
